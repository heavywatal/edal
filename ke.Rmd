...
.plot = function(.indir) {
    ...
    .p = .p + facet_grid(limb ~ key + toepad, as.table=FALSE, labeller=label_both)
...
.plot('default_20141101_121108_57833@pohjola-2.local')
default_20141101_120805_57797@pohjola-2.local
.plot('default_20141101_120805_57797@pohjola-2.local')
.plot('default_20141101_120512_57765@pohjola-2.local')
.plot('default_20141101_120206_57722@pohjola-2.local')
.plot('default_20141101_115647_57620@pohjola-2.local')
.plot('default_20141101_115348_57576@pohjola-2.local')
.plot('default_20141101_114355_57378@pohjola-2.local')
```
...
#.indir = 'default_20141101_111637_56875@pohjola-2.local'
.indir = 'default_20141101_113114_57121@pohjola-2.local'
    .indir = .indirs[1]
    .raw = read.csv(file.path(.indir, 'possible_ke.csv.gz'))
    .tidy = .raw %>>%
        gather(key, Ke, starts_with('Ke')) %>>%
